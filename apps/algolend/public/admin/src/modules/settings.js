...
const getRoleBadge = (role) => {
  switch (role) {
    ...
    case 'base_admin': return 'bg-[var(--color-primary)/15] text-[var(--color-primary)] border-[var(--color-primary)]';
...
const updateThemeSaveState = () => {
  ...
  if (status) {
    ...
    status.className = themeHasPendingChanges ? 'text-xs text-[var(--color-primary)] font-bold' : 'text-xs text-green-600 font-bold';
  }
};
    ...
    <div id="role-modal" class="hidden fixed inset-0 bg-gray-900/50 z-50 flex items-center justify-center backdrop-blur-sm">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 transform transition-all scale-100">
            ...
            <form id="role-form">
                ...
                <select id="modal-role-select" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] mb-6">
                ...
                <form id="profile-form" class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" id="prof-name" value="${currentUserProfile.full_name || ''}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Contact Number</label>
                            <input type="text" id="prof-phone" value="${currentUserProfile.contact_number || ''}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]">
                        </div>
                    </div>
            ...
            <div class="glass-card p-8 rounded-2xl">
                <form id="security-form" class="space-y-5">
                    <div>
                        ...
                        <input type="password" id="sec-pass" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="••••••••">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Confirm Password</label>
                        <input type="password" id="sec-confirm" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="••••••••">
                    </div>
                    <div class="pt-4">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div class="relative w-full sm:w-72">
            <input type="text" id="user-search" placeholder="Search users..." 
                   class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] text-sm transition-shadow">
            ...
            <section class="glass-card p-8 rounded-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="text" id="company-name-input" value="${companyNameAttr}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]">
                    </div>
                    <div>
                        ...
                        <div class="flex flex-col lg:flex-row gap-4">
                            ...
                            <div class="space-y-3 flex-1">
                                ...
                                <div class="flex gap-2">
                                    <input type="url" id="logo-url-input" value="${currentLogo}" class="flex-1 border-gray-300 rounded-lg p-1.5 text-xs focus:ring-[var(--color-primary)]" placeholder="https://...">
            ...
            <section class="glass-card p-8 rounded-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="ncr-number-input" value="${escapeHtmlAttr(systemSettingsDraft.ncr_number || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="NCRCP12345">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Company Registration Number</label>
                        <input type="text" id="company-reg-input" value="${escapeHtmlAttr(systemSettingsDraft.company_reg_number || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="2023/123456/07">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">VAT Number</label>
                        <input type="text" id="company-vat-input" value="${escapeHtmlAttr(systemSettingsDraft.company_vat_number || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="4012345678">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Branch Code (for contracts)</label>
                        <input type="text" id="provider-branch-code-input" value="${escapeHtmlAttr(systemSettingsDraft.provider_branch_code || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="ZFS">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Company Phone</label>
                        <input type="text" id="company-phone-input" value="${escapeHtmlAttr(systemSettingsDraft.company_phone || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="0691195046">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Physical Address</label>
                        <input type="text" id="company-physical-address-input" value="${escapeHtmlAttr(systemSettingsDraft.company_physical_address || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="123 Main Street, Johannesburg, 2001">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Postal Address</label>
                        <input type="text" id="company-postal-address-input" value="${escapeHtmlAttr(systemSettingsDraft.company_postal_address || '')}" class="w-full border-gray-300 rounded-lg p-2.5 text-sm focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)]" placeholder="PO Box 1234, Johannesburg, 2001">
                    </div>
                </div>
            </section>
                    ...
                    ${COLOR_FIELDS.map(f => `
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="text" data-color-input="${f.key}" value="${systemSettingsDraft[f.key]}" class="flex-1 border-gray-300 rounded-lg p-2 text-sm font-mono uppercase focus:ring-[var(--color-primary)]">
                            </div>
                        </div>`).join('')}
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-2">
                                <input type="url" id="wallpaper-url-input" value="${currentWallpaper}" class="flex-1 border-gray-300 rounded-lg p-1.5 text-xs focus:ring-[var(--color-primary)]" placeholder="https://...">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer pt-2">
                                <input type="checkbox" id="wallpaper-flip-toggle" class="rounded text-[var(--color-primary)]" ${wallpaperFlipChecked ? 'checked' : ''}>
                    ...
                    <div class="space-y-4">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" id="overlay-disable-toggle" class="rounded text-[var(--color-primary)]" ${overlayDisabledChecked ? 'checked' : ''}>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ${carouselSlides.map((slide, i) => `
                        <div class="space-y-2 p-3 bg-surface-container rounded-xl border border-outline-variant/10">
                            ...
                            <input type="text" value="${escapeHtmlAttr(slide.title)}" data-carousel-index="${i}" data-carousel-field="title" class="w-full border-gray-300 rounded-lg text-sm font-bold p-2 focus:ring-[var(--color-primary)]" placeholder="Title">
                            <textarea rows="3" data-carousel-index="${i}" data-carousel-field="text" class="w-full border-gray-300 rounded-lg text-xs p-2 focus:ring-[var(--color-primary)] resize-none" placeholder="Description">${escapeHtmlContent(slide.text)}</textarea>
                        </div>
                    `).join('')}
                </div>
            </section>
