    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      <div class="flex flex-col xl:flex-row xl:items-end xl:justify-between gap-6 mb-8">
        <div>
          ...
          <p class="text-[11px] font-black uppercase tracking-[0.2em] text-[var(--color-primary)] mb-2">SureSystems / DebiCheck</p>
          <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight flex items-center gap-3">
            <i class="fa-solid fa-file-invoice text-[var(--color-primary)]"></i> Mandate Control Room
          </h1>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
        <section class="xl:col-span-2 bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <label class="block">
              ...
              <input id="test-application-id" type="number" min="1" placeholder="e.g. 1234" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            <label class="block">
              <span class="text-xs font-bold uppercase tracking-wider text-gray-500">Front End User</span>
              <input id="test-front-end-user" type="text" placeholder="ops@company.co.za" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            <label class="block">
              <span class="text-xs font-bold uppercase tracking-wider text-gray-500">Collection Date</span>
              <input id="test-collection-date" type="date" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            <label class="block">
              <span class="text-xs font-bold uppercase tracking-wider text-gray-500">Contract Reference</span>
              <input id="test-contract-reference" type="text" placeholder="Optional override" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            <div class="md:col-span-2 flex flex-wrap gap-3 pt-2">
              ...
              <button id="btn-live-activate" class="px-4 py-3 rounded-xl bg-[var(--color-primary)] text-white font-bold hover:bg-[var(--color-primary)] transition-all shadow-sm">
        ...
        <section class="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div class="p-6 space-y-4">
            <label class="block">
              <span class="text-xs font-bold uppercase tracking-wider text-gray-500">Application ID</span>
              <input id="action-application-id" type="number" min="1" placeholder="Used for DB write-back" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            <label class="block">
              <span class="text-xs font-bold uppercase tracking-wider text-gray-500">Contract Reference</span>
              <input id="action-contract-reference" type="text" placeholder="Paste contract reference" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            <label class="block">
              <span class="text-xs font-bold uppercase tracking-wider text-gray-500">Front End User</span>
              <input id="action-front-end-user" type="text" placeholder="webuser" class="mt-2 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 outline-none">
            </label>
            ...
            <div class="rounded-2xl border border-dashed border-[var(--color-primary)] bg-[var(--color-primary)/10] p-4">
              <h3 class="text-sm font-bold text-[var(--color-primary)] mb-2">Operational Notes</h3>
          ...
          <div class="p-5 border-b border-gray-100 flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
              <div class="relative w-full sm:w-80">
                ...
                <input id="mandate-search" type="text" placeholder="Search by name, contract ref, or app ID..." class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent text-sm bg-gray-50">
              </div>
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody id="mandates-table-body" class="bg-white divide-y divide-gray-100">
                <tr><td colspan="5" class="px-6 py-12 text-center text-gray-500"><i class="fa-solid fa-spinner fa-spin text-2xl mb-2 text-[var(--color-primary)]"></i><p>Loading mandates...</p></td></tr>
              </tbody>
            </table>
          </div>
    ...
    return `
      <tr class="hover:bg-gray-50 transition-colors group">
        ...
        <td class="px-6 py-4 text-right">
          <button class="view-mandate-btn text-gray-400 hover:text-[var(--color-primary)] transition-colors bg-white hover:bg-[var(--color-primary)/10] w-9 h-9 rounded-xl border border-transparent hover:border-[var(--color-primary)]" data-id="${escapeHtml(item.id)}">
...
async function loadMandates() {
  const tbody = document.getElementById('mandates-table-body');
  if (tbody) {
    tbody.innerHTML = `<tr><td colspan="5" class="px-6 py-12 text-center text-gray-500"><i class="fa-solid fa-spinner fa-spin text-2xl mb-2 text-[var(--color-primary)]"></i><p>Loading mandates...</p></td></tr>`;
  }
