...
function renderTable() {
    ...
    const labelColor = isHighlightActive ? "text-[var(--color-primary)]" : "text-gray-900";
...
const renderRow = (row) => {
    ...
    else if (isFlagged) rowClasses += ' bg-yellow-50 border-l-4 border-l-[var(--color-primary)]';
        ...
        <tr class="${rowClasses}">
            ...
            <td class="px-4 py-4 text-center print:hidden">
                <div class="flex items-center justify-center gap-2">
                    ...
                    <button class="flag-btn p-1.5 hover:bg-[var(--color-primary)/15] rounded-md" data-id="${rowId}">
                        <i class="${isFlagged ? 'fa-solid fa-flag text-[var(--color-primary)]' : 'fa-regular fa-flag text-gray-400'}"></i>
                    </button>
                </div>
            </td>
        </tr>`;
