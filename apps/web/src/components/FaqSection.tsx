...
const FAQS = [
  ...
  },
  {
    ...
    a: "Hosting and infrastructure, all security patches, regulatory updates (including SACRRA layout changes), new platform features, and priority support. Pass-through API costs (Experian, TruID, DocuSeal) are billed at cost with no markup.",
  },
  {
