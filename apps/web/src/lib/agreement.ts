...
// Version tag — bump this string any time AGREEMENT_TEXT changes.
// The sign API stores this tag alongside each signature so there is always
// a precise audit record of which version was agreed to.
export const AGREEMENT_VERSION = 'v1.0.0-2024';
